package com.example.spring05.model.board.dao;
...
public class BoardDAOImpl implements BoardDAO {
	...
	@Override
	public List<BoardDTO> adminReq() {
		return sqlSession.selectList("board.adminReq");
	}

	@Override
	public void permit(BoardDTO dto) {
		sqlSession.update("board.permit",dto);
